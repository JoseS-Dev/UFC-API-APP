...
RoutesEvent.get('/all', controllerEvents.getAllEvents);
// Ruta para obtener un evento por su ID
RoutesEvent.get('/event/:id', controllerEvents.getEventById);
...
RoutesEvent.patch('/event/update/:id', uploadEventImage, controllerEvents.updateEvent);
// Ruta para eliminar un evento por su ID
RoutesEvent.delete('/event/delete/:id', controllerEvents.deleteEvent);